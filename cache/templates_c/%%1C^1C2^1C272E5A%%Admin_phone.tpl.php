<?php /* Smarty version 2.6.26, created on 2018-09-07 04:32:09
         compiled from D:%5CCODE%5Ccode%5Cthuocdongy%5Ctemplates/Admin_phone/Admin_phone.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('insert', 'getImageNews', 'D:\\CODE\\code\\thuocdongy\\templates/Admin_phone/Admin_phone.tpl', 71, false),array('insert', 'formatTime', 'D:\\CODE\\code\\thuocdongy\\templates/Admin_phone/Admin_phone.tpl', 226, false),)), $this); ?>
<script>
<?php echo '
var	is_submit		=	false;
...
<input type="hidden" name="form_block" value="Admin_news">
<div class="admin_block">
	<div class="mod_title marginBottom10">Danh sách yêu cầu gọi lại</div>  
    <div>
...
" title="Chọn tất cả" /></td>
            ...
            <td class="rowtop">Điện thoại yêu cầu</td>
            <td class="rowtop">Nội Dung</td>
            <td class="rowtop" width="115">Ngày yêu cầu</td>
...
" style="cursor:pointer" onClick="select_checkbox(this.form,'chk',this,'#ffffcc','white');"></td>
            ...
            <td class="padding5" style="text-align:left"><?php echo $this->_tpl_vars['item']['title']; ?>
			 ...
			 <br/>
			 <?php echo $this->_tpl_vars['item']['to_email']; ?>
