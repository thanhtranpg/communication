<?php /* Smarty version 2.6.26, created on 2019-01-11 03:28:43
         compiled from D:%5CCODE%5Ccode%5Ccommunication.com%5Ctemplates/Admin_adv/Admin_adv.tpl */ ?>
<script>
<?php echo '
var	is_submit		=	false;
...
<div class="admin_block">
	<div class="mod_title marginBottom10"><?php if ($this->_tpl_vars['cmd'] == 'add'): ?>Thêm<?php else: ?>Sửa<?php endif; ?> ảnh</div>        	
        ...
        <div class="float_left">
        	<select name="catid" class="input_text" style="width:200px;">
                <?php $_from = $this->_tpl_vars['adv_zone']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['zone'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['zone']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['key'] => $this->_tpl_vars['zone']):
        $this->_foreach['zone']['iteration']++;
?>
                <option value="<?php echo $this->_tpl_vars['key']; ?>
" <?php if ($this->_tpl_vars['key'] == $this->_tpl_vars['item']['catid']): ?>selected<?php endif; ?>>&raquo; <?php echo $this->_tpl_vars['zone']['title']; ?>
 (<?php echo $this->_tpl_vars['zone']['w']; ?>
x<?php echo $this->_tpl_vars['zone']['h']; ?>
)</option>
...
"></div>
        ...
        <div class="float_left"><input type="file" id="image" name="image" class="input_text" size="60"/> <?php if ($this->_tpl_vars['item']['image']): ?>
            <div class="clear paddingBottom5"></div>
...
" />
        ...
        <div class="float_left" style="width:50%;"">
                 <textarea id="description" name="description" rows="6" style="width:100%"  ><?php echo $this->_tpl_vars['item']['description']; ?>
</textarea>
        </div>
        <div class="clear paddingBottom5"></div>  
...
" maxlength="60"></div>
        ...
        <div class="float_left">
        	<select name="status" class="input_text" style="width:200px;">
            	...
            	<option value="0" <?php if ($this->_tpl_vars['item']['status'] == 0): ?>selected<?php endif; ?>>Không kích hoạt</option>                
            </select>
        </div>
        <div class="clear paddingBottom5"></div>           
...
<div class="admin_block">
    ...
    <div class="float_left">
        <select name="s_catid" class="input_text" style="width:200px;">
        	<option value="0" <?php if ($this->_tpl_vars['s_catid'] == 0): ?>selected<?php endif; ?>>...Tất cả</option>
            <?php $_from = $this->_tpl_vars['adv_zone']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['zone'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['zone']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['key'] => $this->_tpl_vars['zone']):
        $this->_foreach['zone']['iteration']++;
?>
            <option value="<?php echo $this->_tpl_vars['key']; ?>
" <?php if ($this->_tpl_vars['key'] == $this->_tpl_vars['s_catid']): ?>selected<?php endif; ?>>&raquo; <?php echo $this->_tpl_vars['zone']['title']; ?>
 (<?php echo $this->_tpl_vars['zone']['w']; ?>
x<?php echo $this->_tpl_vars['zone']['h']; ?>
)</option>
            <?php endforeach; endif; unset($_from); ?>
...
"></div>
    ...
    <div class="float_left">
        <select name="s_status" class="input_text" style="width:200px;">
            ...
            <option value="0" <?php if ($this->_tpl_vars['s_status'] === 0): ?>selected<?php endif; ?>>Không kích hoạt</option>                
        </select>
    </div>
    <div class="clear paddingBottom5"></div>
...
" style="cursor:pointer" onClick="select_checkbox(this.form,'chk',this,'#ffffcc','white');"></td>
            ...
            <img src="/uploads/<?php echo $this->_tpl_vars['item']['image']; ?>
" width="150"></td>
            <td><?php echo $this->_tpl_vars['adv_zone'][$this->_tpl_vars['item']['catid']]['title']; ?>
</td>
