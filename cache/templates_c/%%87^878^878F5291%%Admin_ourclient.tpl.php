<?php /* Smarty version 2.6.26, created on 2019-01-11 03:28:39
         compiled from D:%5CCODE%5Ccode%5Ccommunication.com%5Ctemplates/Admin_ourclient/Admin_ourclient.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('insert', 'getImageUrl', 'D:\\CODE\\code\\communication.com\\templates/Admin_ourclient/Admin_ourclient.tpl', 60, false),)), $this); ?>
<script>
<?php echo '
var	is_submit		=	false;
...
<div class="admin_block">
	<div class="mod_title marginBottom10">Our Clients</div>
...
<input type="hidden" name="form_block" value="Admin_ourclient">
<div class="admin_block">
...
"></div>
    	...
    	<div class="float_left marginRight10"  style="width:20%; text-align:right">Upload file</div>
...
echo smarty_core_run_insert_handler(array('args' => array('name' => 'getImageUrl', 'img' => $this->_tpl_vars['item']['image'], 'path' => 'adv')), $this); ?>
">[View]</a><input type="hidden" name="old_image" value="<?php echo $this->_tpl_vars['item']['image']; ?>
" /><?php endif; ?></div>

        <div class="clear paddingBottom5"></div>
                        
        <div class="float_left marginRight10" style="width:20%; text-align:right">Liên kết</div>
...
" style="cursor:pointer" onClick="select_checkbox(this.form,'chk',this,'#ffffcc','white');"></td>
            ...
            <td class="padding5" style="text-align:left"><?php echo $this->_tpl_vars['item']['link']; ?>
</td>
            <td class="padding5" style="text-align:left"><img src="/uploads/<?php echo $this->_tpl_vars['item']['image']; ?>
" width="100"></td>
