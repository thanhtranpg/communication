<?php /* Smarty version 2.6.26, created on 2019-01-10 09:16:57
         compiled from D:%5CCODE%5Ccode%5Ccommunication.com%5Ctemplates/Admin_config/Admin_config.tpl */ ?>
...
"></div>
        ...
        <div class="float_left"><input  type="checkbox" id="sendemail" name="sendemail" class="check"  value="1" <?php if ($this->_tpl_vars['item']['sendemail'] == 1): ?> checked="checked" <?php endif; ?> ></div>
        <div class="clear paddingBottom5"></div>
...
"></div>
        ...
        <div class="float_left"><input type="input" id="youtube_id" name="youtube_id" class="input_text" style="width:400px" value="<?php echo $this->_tpl_vars['item']['youtube_id']; ?>
"></div>
        <div class="clear paddingBottom5"></div>
        <div class="float_left marginRight10" style="width:35%; text-align:right">Youtube ID Play</div>
        <div class="float_left"><input type="input" id="youtube_id_play" name="youtube_id_play" class="input_text" style="width:400px" value="<?php echo $this->_tpl_vars['item']['youtube_id_play']; ?>
"></div>
        <div class="clear paddingBottom5"></div>
        <div class="float_left marginRight10" style="width:35%; text-align:right">Tiêu Đề Trên Nền Video Trang Chủ</div>
        <div class="float_left"><input type="input" id="home_title" name="home_title" class="home_title" style="width:400px" value="<?php echo $this->_tpl_vars['item']['home_title']; ?>
"></div>
        <div class="clear paddingBottom5"></div>
        <div class="float_left marginRight10" style="width:35%; text-align:right">Nội Dung Trên Nền Video Trang Chủ</div>
        <div class="float_left">
            
            <textarea id="home_description" name="home_description" class="input_text" style="width:400px; height:50px"><?php echo $this->_tpl_vars['item']['home_description']; ?>
</textarea>
        </div>
        <div class="clear paddingBottom5"></div>
       	</div>
...
"></div>
        ...
        <div class="float_left"><input type="input" id="email_contact" name="email_contact" class="input_text" style="width:400px" value="<?php echo $this->_tpl_vars['item']['email_contact']; ?>
"></div>
        <div class="clear paddingBottom5"></div>

        
        <div class="float_left marginRight10" style="width:35%; text-align:right">Facebook Link</div>
        <div class="float_left"><input type="input" id="facebooklink" name="facebooklink" class="facebooklink" style="width:400px" value="<?php echo $this->_tpl_vars['item']['facebooklink']; ?>
"></div>
        <div class="clear paddingBottom5"></div>
        
        <div class="float_left marginRight10" style="width:35%; text-align:right">Youtube Link</div>
        <div class="float_left"><input type="input" id="youtubelink" name="youtubelink" class="youtubelink" style="width:400px" value="<?php echo $this->_tpl_vars['item']['youtubelink']; ?>
"></div>
        <div class="clear paddingBottom5"></div>
