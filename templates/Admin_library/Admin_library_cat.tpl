...
<div class="admin_block">
    ...
    <div class="menu_child paddingBottom10">
        ...
        <a href="webadmin.php?main={$main}&cmd=list">Danh sách sản p hẩm</a>
    </div>
</div>    
<!--End Child Menu-->
...
<!--Edit Cat-->
{if $item}
<form name="Admin_library_catForm" id="Admin_library_catForm"  method="post"  enctype="multipart/form-data">
<input type="hidden" name="form_block" value="Admin_library" />
<div class="admin_block">
	<div class="mod_title marginBottom10">{if $cmd == 'addcat'}Thêm{else}Sửa{/if} danh mục thư viện</div>        	
    <!--
        ...
        <div class="clear paddingBottom5"></div>
        	<div class="float_left marginRight10" style="width:35%; text-align:right">Upload ảnh (298 X 202)</div>
        ...
        <div class="float_left"><input type="input" id="key_word" name="key_word" class="input_text" style="width:200px" value="{$item.key_word}" maxlength="100"></div>
        <div class="clear paddingBottom5"></div>-->
...
<!--List Cat-->
{if $listcat}
<form name="Admin_library_catForm" id="Admin_library_catForm"  method="post">
<input type="hidden" name="form_block" value="Admin_library">
<div class="admin_block">
    ...
    <div>
    	<table width="100%" border="0" cellspacing="1" cellpadding="1" class="tbl_list">
          ...
          {/foreach}
          <tr class="row">
          	<td colspan="7" class="paddingLeft5" style="text-align:left; height:30px"><input type="button" value="Xóa" class="button" onclick="DelSelectForm('Admin_library_catForm','chk')" /></td>
          </tr>
        </table>
    </div>
</div> 
