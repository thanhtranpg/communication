<?php /* Smarty version 2.6.26, created on 2019-01-07 08:09:20
         compiled from D:%5CCODE%5Ccode%5Ccommunication.com%5Ctemplates/Admin_changepass/Admin_changepass.tpl */ ?>
<script>
<?php echo '
var	is_submit		=	false;
...
<div class="admin_block">
    ...
    <div class="admin_block" style="width:400px; margin:auto">
        ...
        <div class="float_left"><input type="input" id="old_user" name="old_user" class="input_text" style="width:150px" value="<?php echo $this->_tpl_vars['user']['user']; ?>
" readonly="readonly"></div>
        ...
        <div class="float_left"><input type="password" id="old_pass" name="old_pass" class="input_text" style="width:150px"><input type="hidden" id="old_pass2" name="old_pass2" value="<?php echo $this->_tpl_vars['user']['pwd']; ?>
"></div>
        <div class="clear paddingBottom5"></div>
