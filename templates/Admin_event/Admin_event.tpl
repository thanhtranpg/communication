...
<div class="admin_block">
    <div class="mod_title marginBottom10">Our Events</div>
    <div class="menu_child paddingBottom10">
        <a {if $cmd == 'add'}style="color:red;"{/if} href="webadmin.php?main={$main}&cmd=add">Thêm event</a> | 
        <a {if $cmd == 'list'}style="color:red;"{/if} href="webadmin.php?main={$main}&cmd=list">Danh sách event</a>
    </div>
</div>    
<!--End Child Menu-->
...
<div class="admin_block">
    ...
    <div class="mod_title marginBottom10">{if $cmd == 'add'}Thêm{else}Sửa{/if} event</div>            
        ...
        <div class="float_left"><input type="file" id="image" name="image" class="input_text" size="60"/> {if $item.image}
            ...
            {/if}
            <input type="hidden" name="old_image" value="{$item.image}" />{/if}</div>
    ...
    <div>
        <table width="100%" border="0" cellspacing="1" cellpadding="1" class="tbl_list">
          ...
          <tr class="row" id="chk_tr_{$item.id}">
            ...
            <td class="padding5" style="text-align:left">{$item.link}</td>
            <td class="padding5" style="text-align:left"><img src="/uploads/{$item.image}" width="100"></td>
            <td>{$item.ord}</td>
