<?php /* Smarty version 2.6.26, created on 2019-01-07 08:36:48
         compiled from D:%5CCODE%5Ccode%5Ccommunication.com%5Ctemplates/Admin_news/Admin_news.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('insert', 'getImageNews', 'D:\\CODE\\code\\communication.com\\templates/Admin_news/Admin_news.tpl', 73, false),array('insert', 'getItemImage', 'D:\\CODE\\code\\communication.com\\templates/Admin_news/Admin_news.tpl', 232, false),array('insert', 'formatTime', 'D:\\CODE\\code\\communication.com\\templates/Admin_news/Admin_news.tpl', 237, false),)), $this); ?>
<script>
<?php echo '
var	is_submit		=	false;
...
" <?php if ($this->_tpl_vars['scat']['catid'] == $this->_tpl_vars['s_catid']): ?>selected<?php endif; ?>>&nbsp;&nbsp;&nbsp;&nbsp;&raquo; <?php echo $this->_tpl_vars['scat']['title']; ?>
    ...
    <div class="float_left">
        <select name="s_status" class="input_text" style="width:200px;">
            ...
            <option value="3" <?php if ($this->_tpl_vars['s_status'] == 3): ?>selected<?php endif; ?>>Tin nổi bật</option>
...
echo smarty_core_run_insert_handler(array('args' => array('name' => 'getItemImage', 'img' => $this->_tpl_vars['item']['image'], 'id' => $this->_tpl_vars['item']['id'], 'folder' => 'news', 'type' => '150')), $this); ?>
" width="100" />
