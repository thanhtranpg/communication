<?php /* Smarty version 2.6.26, created on 2019-01-11 06:44:49
         compiled from D:%5CCODE%5Ccode%5Ccommunication.com%5Ctemplates/Admin_ourwork/Admin_ourwork.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('insert', 'getItemImage', 'D:\\CODE\\code\\communication.com\\templates/Admin_ourwork/Admin_ourwork.tpl', 87, false),array('insert', 'formatTime', 'D:\\CODE\\code\\communication.com\\templates/Admin_ourwork/Admin_ourwork.tpl', 212, false),)), $this); ?>
<script>
<?php echo '
var	is_submit		=	false;
...
<div class="admin_block">
	<div class="mod_title marginBottom10"><?php if ($this->_tpl_vars['cmd'] == 'add'): ?>Thêm<?php else: ?>Sửa<?php endif; ?> our work</div>    <div class="float_left marginRight10" style="width:20%; text-align:right">Tiêu đề</div>
...
echo smarty_core_run_insert_handler(array('args' => array('name' => 'getItemImage', 'img' => $this->_tpl_vars['item']['image'], 'id' => $this->_tpl_vars['item']['id'], 'folder' => 'ourwork', 'type' => '610')), $this); ?>
" />
               <br />
               <?php endif; ?> 
...
<input type="hidden" name="form_block" value="Admin_ourwork">
<div class="admin_block">
	<div class="mod_title marginBottom10">Danh sách Our Works | <strong>Tổng : <?php echo $this->_tpl_vars['total']; ?>
</strong></div>  
    <div>
...
if ($this->_foreach['cat']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['cat']):
        $this->_foreach['cat']['iteration']++;
?>
                    <?php if ($this->_tpl_vars['cat']['catid'] == $this->_tpl_vars['item']['catid']): ?>
            ...
            <td><a class="add_imag" href="webadmin.php?main=<?php echo $this->_tpl_vars['main']; ?>
&cmd=img&id=<?php echo $this->_tpl_vars['item']['id']; ?>
"><strong style="color: blue"><?php echo $this->_tpl_vars['item']['total_img']; ?>
</strong><br/>Thêm ảnh</td>
            <td><a class="add_video" href="webadmin.php?main=<?php echo $this->_tpl_vars['main']; ?>
&cmd=video&id=<?php echo $this->_tpl_vars['item']['id']; ?>
"><strong style="color: blue"><?php echo $this->_tpl_vars['item']['total_video']; ?>
</strong><br/>Thêm video</td>
...
&cmd=del&id=',<?php echo $this->_tpl_vars['item']['id']; ?>
          ...
          <tr class="row">
          	<td colspan="7" class="paddingLeft5" style="text-align:left; height:30px">
                <input type="button" value="Xóa" class="button" onclick="DelSelectForm('Admin_ourwork_listForm','chk')" /><?php echo $this->_tpl_vars['pagingData']; ?>
</td>
          </tr>
        </table>
    </div>
