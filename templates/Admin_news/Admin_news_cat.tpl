...
<div class="admin_block">
	<div class="mod_title marginBottom10">{if $cmd == 'addcat'}Thêm{else}Sửa{/if} danh mục tin</div>        	
        ...
        <div class="float_left">
        	<select name="status" class="input_text" style="width:200px;">
            	<option value="1" {if $item.status == 1}selected{/if}>Categories</option>
                <option value="3" {if $item.status == 3}selected{/if}>List</option>
