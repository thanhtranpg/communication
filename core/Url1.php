		...
		if(!REWRITE_ON){
				...
				if ($params){
						...
						switch ($main){
								...
								case 'news':
										$params_order[$main] = array('newsid','xtname','page_no');
										$prefix_params[$main] = array('newsid'		=>'cat'	,
																		'page_no' =>'page'															
															  );
										break;			
							  ...
							  case 'map_travel':
										$params_order[$main] = array('cmd');												  
							  			break;	
						      case 'feedback':
										$params_order[$main] = array('Feedbackid','xtname','page_no');
					         ...
					         case 'guide':
										$params_order[$main] = array('guideid','detailid','xtname','page_no');
										$prefix_params[$main] = array('guideid'		=>'cat'	,
																		'page_no' =>'page'															
															  );
					     ...
					     case 'tour':
										$params_order[$main] = array('catid','Tourid','xtname','cmd','page_no');
										$prefix_params[$main] = array(
																		'page_no' =>'page'															
															  );				  
										break;							
						 case 'hotel':
										$params_order[$main] = array('catid','Hotelid','xtname','cmd','page_no');
										$prefix_params[$main] = array(
																		'page_no' =>'page'															
															  );	
										break;						
					     case 'cruise':
										$params_order[$main] = array('cruise_catid','catid','Cruiseid','xtname','cmd','page_no');
										$prefix_params[$main] = array(
																		'cruise_catid'=>'cat',
																		'page_no' =>'page'															
															  );	
						...
						if($main=='profile' && count($params) == 1 && isset($params['user_name'])){
								...
								if($request_string){
										...
										$request_string = $main.$request_string.$ext.$new_params['other_params'];
								}
